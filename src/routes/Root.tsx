    ...
    return (
        <div style={{minHeight: '95vh'}}>
            ...
            <div className="content-container">
                ...
                <Grid container rowSpacing={2} sx={{margin: 'auto', width: 'auto', marginBottom: '2%'}}>
                ...
                <br/>
                <Link to="/profile">
                    <Button variant="contained" size="large" color="secondary" sx={{marginTop: '2%', height: '4rem', marginBotton: '2%'}}>Get Started</Button>
                </Link>
            </div>
            </div>
        </div>
